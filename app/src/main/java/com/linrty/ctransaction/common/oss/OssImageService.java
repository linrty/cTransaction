...
public class OssImageService {
    ...
    public OssImageService(OssService ossService) {
    ...
    public void textWatermark(String object, String text, int size) {
        ...
        LogUtils.d("TextWatermark", object);
        LogUtils.d("Text", text);
        LogUtils.d("QuerySyring", queryString);
    ...
    public void resize(String object, int width, int height) {
        ...
        LogUtils.d("ResizeImage", object);
        LogUtils.d("Width", String.valueOf(width));
        LogUtils.d("Height", String.valueOf(height));
        LogUtils.d("QueryString", queryString);
