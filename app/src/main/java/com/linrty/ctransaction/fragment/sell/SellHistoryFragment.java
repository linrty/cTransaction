package com.linrty.ctransaction.fragment.sell;
...
public class SellHistoryFragment extends Fragment {
 ...
 private void initView(){
  ...
  RecyclerViewUtil.INSTANCE.bindingSellHistoryList(binding.workListRV,model.getList(),navController);
 }
}
